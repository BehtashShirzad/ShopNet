        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Inventory_Balances", "[OnHandQuantity] >= 0 AND [ReservedQuantity] >= 0 AND [ReservedQuantity] <= [OnHandQuantity]");
                    table.CheckConstraint("CK_Inventory_ReorderPoint", "[ReorderPoint] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationAttempts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockReceipts", x => x.ReferenceId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationAttempts_OrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationAttempts_Status_ExpiresAtUtc",
                table: "ReservationAttempts",
