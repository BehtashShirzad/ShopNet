...
public sealed class CatalogContainersFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        {
            InitialCatalog = $"CatalogTests_{Guid.NewGuid():N}"
        }.ConnectionString;
    }
...
public sealed class CatalogContainersCollection : ICollectionFixture<CatalogContainersFixture>
{
    public const string Name = "Catalog containers";
}
